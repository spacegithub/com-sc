package com.sc.excel.test;

import com.sc.excel.EasyExcelFactory;
import com.sc.excel.ExcelWriter;
import com.sc.excel.metadata.Sheet;
import com.sc.excel.metadata.Table;
import com.sc.excel.support.ExcelTypeEnum;
import com.sc.excel.test.model.WriteModel;
import com.sc.excel.test.util.FileUtil;
...
import static com.sc.excel.test.util.DataUtil.createTableStyle;
import static com.sc.excel.test.util.DataUtil.createTestListJavaMode;
import static com.sc.excel.test.util.DataUtil.createTestListObject;
import static com.sc.excel.test.util.DataUtil.createTestListStringHead;
...
public class WriteTest {
    ...
    public void writeV2003() throws IOException {
        OutputStream out = new FileOutputStream("/2003.xls");
