...
public class WorkBookUtil {
    ...
    public static Sheet createOrGetSheet(Workbook workbook, com.sc.excel.metadata.Sheet sheet) {
        Sheet sheet1 = null;
        try {
            try {
    ...
    public static Sheet createSheet(Workbook workbook, com.sc.excel.metadata.Sheet sheet) {
