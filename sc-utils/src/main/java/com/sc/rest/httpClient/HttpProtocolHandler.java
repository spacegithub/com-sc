package com.sc.rest.httpClient;
 ...
 *
 * HttpRequest request = new HttpRequest(HttpResultType.BYTES); //设置编码集
 * request.setCharset(aliPayConf.getInput_charset());
 *
 * request.setParameters(generatNameValuePair(sPara));//使用map转NameValuePair
 * request.setUrl("");
 *
 * HttpResponse response = httpProtocolHandler.execute(request, strParaFileName, strFilePath); </p>
 *
 *
 *map转NameValuePair
 * <p>
