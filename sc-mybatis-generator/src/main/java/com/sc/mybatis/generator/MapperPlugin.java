...
public class MapperPlugin extends PluginAdapter {
    ...
    private boolean caseAlias=true;
    private boolean caseRepository=true;
    @Override
    ...
    public void setProperties(Properties properties) {
        ...
        String caseAlias=this.properties.getProperty("caseAlias");
        if (StringUtility.stringHasValue(caseAlias)){
            this.caseAlias=caseAlias.equalsIgnoreCase("TRUE");
        }

        String caseRepository=this.properties.getProperty("caseRepository");
        if (StringUtility.stringHasValue(caseRepository)){
            this.caseRepository=caseAlias.equalsIgnoreCase("TRUE");
        }
    }
