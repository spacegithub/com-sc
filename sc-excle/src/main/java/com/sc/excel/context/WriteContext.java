...
import com.sc.excel.util.StyleUtil;
...
import static com.sc.excel.util.StyleUtil.buildSheetStyle;
...
public class WriteContext {
     ...
     * current param
     */
    private com.sc.excel.metadata.Sheet currentSheetParam;
     ...
     * @param sheet
     */
    public void currentSheet(com.sc.excel.metadata.Sheet sheet) {
    ...
    private void initCurrentSheet(com.sc.excel.metadata.Sheet sheet) {
    ...
    private void addMergedRegionToCurrentSheet(int startRow) {
        for (com.sc.excel.metadata.CellRange cellRangeModel : excelHeadProperty.getCellRangeModels()) {
    ...
    private void initTableStyle(com.sc.excel.metadata.TableStyle tableStyle) {
        if (tableStyle != null) {
    ...
    public com.sc.excel.metadata.Sheet getCurrentSheetParam() {
        return currentSheetParam;
    }

    public void setCurrentSheetParam(com.sc.excel.metadata.Sheet currentSheetParam) {
